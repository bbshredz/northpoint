...
export const NETSUITE_RECORDS = [
  {
    ...
    color: '#f59e0b',
    fields: [
      { id: 'ns.vendor.entityId',          label: 'Entity ID' },
      { id: 'ns.vendor.companyName',       label: 'Company Name' },
      ...
      { id: 'ns.vendor.subsidiary',        label: 'Subsidiary' },
    ],
  },
  {
    id: 'ns_employee',
    ...
    fields: [
      ...
      { id: 'ns.emp.firstName',      label: 'First Name' },
      { id: 'ns.emp.lastName',       label: 'Last Name' },
      { id: 'ns.emp.department',     label: 'Department' },
      { id: 'ns.emp.subsidiary',     label: 'Subsidiary' },
      { id: 'ns.emp.supervisor',     label: 'Supervisor' },
      { id: 'ns.emp.employeeType',   label: 'Employee Type' },
      { id: 'ns.emp.title',          label: 'Job Title' },
      { id: 'ns.emp.startDate',      label: 'Start Date' },
  ...
  },
  {
    ...
    color: '#06b6d4',
    fields: [
      { id: 'ns.coa.accountNumber',   label: 'Account Number' },
      { id: 'ns.coa.acctName',        label: 'Account Name' },
      { id: 'ns.coa.acctType',        label: 'Account Type' },
      { id: 'ns.coa.parent',          label: 'Parent Account' },
      { id: 'ns.coa.subsidiary',      label: 'Subsidiary' },
  ...
  },
  {
    ...
    color: '#f97316',
    fields: [
      { id: 'ns.vb.entity',      label: 'Vendor (entity)' },
      { id: 'ns.vb.tranDate',    label: 'Transaction Date' },
      { id: 'ns.vb.tranId',      label: 'Reference / Inv Number' },
      { id: 'ns.vb.memo',        label: 'Memo' },
      { id: 'ns.vb.dueDate',     label: 'Due Date' },
      { id: 'ns.vb.subsidiary',  label: 'Subsidiary' },
      { id: 'ns.vb.location',    label: 'Location' },
      { id: 'ns.vb.account',     label: 'Expense Account' },
      { id: 'ns.vb.department',  label: 'Department' },
      { id: 'ns.vb.amount',      label: 'Amount' },
    ],
  },
];
